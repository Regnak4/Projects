...
Car::Car(double capacity, double consumption, const Point& location, const std::string& model) : fuelCapacity(60) , fuelConsumption(0.6) , location(0, 0), model("Mercedes"){
    this->fuelAmount = 0;
