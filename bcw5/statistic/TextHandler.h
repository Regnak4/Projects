...
class TextHandler {
    private:
        ...
        void insert(char symbol, std::vector<char>* word);
        void insert(std::vector<char>* word, std::set<std::string>* lst);
        void insert(std::vector<char>* word, std::map<std::string, int>* lst);
